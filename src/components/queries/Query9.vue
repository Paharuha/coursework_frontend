...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                headers: [
                    ...
                    {text: 'Назва підрядника', value: 'subcontracting', sortable: false},
                    {text: 'Робоча група', value: 'groupPeople', sortable: false},
                ],
                loading: false,
        ...
        methods: {
            ...
            search() {
                axios.get(`/api/contracts/find-by-subconracting`, {
                    params: {
                        name: this.currentSubcintracting.name
                    }
                })
                    .then(response => {
        ...
        mounted() {
            axios.get(`/api/subcontracting`)
                .then(res => this.subcontracting = res.data);
        }
    }
</script>
